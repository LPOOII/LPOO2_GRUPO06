...
SELECT        dbo.Articulo.art_id, dbo.Articulo.art_descrip, dbo.Articulo.art_costo, dbo.Articulo.art_margen_beneficio, dbo.Articulo.art_precio, dbo.Articulo.art_stock_min, 
                         ...
                         dbo.Familia.fam_descrip, dbo.Articulo.um_id, dbo.Unidad_Medida.um_descrip
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'Vista_Articulos', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'Vista_Articulos', NULL, NULL
GO
